package com.thiago.webrtc.webrtc
...
class WebrtcClient @Inject constructor(
    ...
    //Servidor TCP -> comunicação direta, na qual uma conexão confiável é necessária, como navegação na web, e-mail, mensagens de texto e transferência de arquivos.
